$(document).ready(function () {
    ...
    $('#datatables tbody').on('click', 'a', function (e) {
        ...
        if ($(e.target).attr('class') === 'fas fa-share-alt') {
            location.href = '/Dashboards/Connection?id=' + data["boardID"];    
        }
