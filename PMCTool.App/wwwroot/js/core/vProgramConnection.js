...
function getAvailableChildren() {
    $.ajax({
        type: 'GET',
        url: "/Programs/GetAvaliableChildren",
        dataType: 'json',
        beforeSend: function () {
            //LoaderShow();
        },
...
function createEntry() {
    ...
    $.ajax({
        type: 'POST',
        url: '/Programs/CreateConnection',
        dataType: 'json',
        data: { id: $("#ChildID").val(), parent: $("#ProgramID").val(), order: $("#OrderID").val(), percentage: $("#Weighing").val() },
        beforeSend: function () {
            LoaderShow();
        },
        success: function (data) {
...
function updateEntry() {
    ...
    table.rows().every(function (rowIdx, tableLoop, rowLoop) {
        ...
        var item = { projectID: data.projectID, order: nOrder, percentage: nWeighing, parentID: $('#ProgramID').val() };
        items.push(item);
    });
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: { id: $("#ProgramID").val(), data: items },
        beforeSend: function () {
            LoaderShow();
        },
        success: function (data) {
