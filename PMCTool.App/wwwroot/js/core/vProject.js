$(document).ready(function () {
        ...
        columns: [
            ...
            { data: "updatedByName" },
            {
                ...
                render: function (url, type, full) {
                    if (full.phase == 1)
                        return '<a class="btn btn-link btn-warning" data-toggle="tooltip" title="' + $("#Edit").val() + '"><i class="fa fa-edit"></i></a>&nbsp;<a class="btn btn-link btn-danger" data-toggle="tooltip" title="' + $("#Delete").val() + '"><i class="far fa-trash-alt"></i></a>&nbsp;<a class="btn btn-link btn-info" data-toggle="tooltip" title="' + $("#Participant").val() + '"><i class="fas fa-address-card"></i></a>'
                    else
                        return '<a class="btn btn-link btn-warning" data-toggle="tooltip" title="' + $("#Edit").val() + '"><i class="fa fa-edit"></i></a>&nbsp;<a class="btn btn-link btn-info" data-toggle="tooltip" title="' + $("#Participant").val() + '"><i class="fas fa-address-card"></i></a>'
                }
            }
        ],
        language: {
    ...
    $('#datatables tbody').on('click', 'a', function (e) {
        ...
        if ($(e.target).attr('class') === 'fa fa-edit') {
            location.href = '/Projects/Editor?id=' + data.projectID;
        }
        ...
        if ($(e.target).attr('class') === 'fas fa-address-card') {
            location.href = '/Projects/Participants?id=' + data.projectID;
        }
    });
